...
const API_CACHE_URLS = ["/api/translations"];
...
// ... rest of your existing fetch handler code
...
self.addEventListener("push", (event) => {
  ...
  event.waitUntil(self.registration.showNotification("ECHO", options));
});
...
self.addEventListener("notificationclick", (event) => {
  ...
  if (event.action === "explore") {
    event.waitUntil(clients.openWindow("/translate"));
  }
});
